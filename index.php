...
<body>
    <div class="header">
        <div class="row">
            <div class="col-lg-6">
                <span class="logo">Hazel Quiz System</span>
            </div>
    ...
    <div class="bg1">
        <div class="row">
            ...
            <div class="col-md-6">
                <center>
                    <div class="intro" style="margin-top: 220px;">
                        <h1
                            style="color: #fff;text-transform: uppercase;font-size: 65px;font-weight: 700;letter-spacing: 0.015em;">
                            hazel <br> quiz system </h1>
                        <h2
                            style="color: red;text-transform: uppercase;font-size: 35px;font-weight: 700;letter-spacing: 0.015em;">
                            Good Luck. </h2>
                    </div>
                </center>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form role="form" method="post" action="admin.php?q=index.php">
                                <div class="form-group">
                                    <input type="text" name="uname" maxlength="20" placeholder="Admin user email"
                                        class="form-control" />
                                </div>
                                <div class="form-group">
